                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr :key="item._id" v-for="(item,index) in strategyList">
                            ...
                            <td class="operation">
                                <a class='clickable' @click="turn_histroy(item.property.name)" title="历史"><i class="icon-history"></i></a>
                                <a v-if="power=='rw'" class='clickable' @click="editView(item,index)" title="编辑"><i class="icon-edit"></i></a>
                            ...
                            <div class="nomaltype" v-show="warnconf.type === 'basic'">
                                <div class="left_content_box">
                                    ...
                                    <div class="three clearfix">
                                        ...
                                        <p class="left_title fl" style="margin-left: 0.25rem;margin-right: 0.25rem;">告警等级</p>
                                        <el-select v-model="warnconf.level" style="width:4.5rem;" class="fl key_input" placeholder="请选择">
                                            <el-option v-for="item in levels" :key="item.label" :label="item.label" :value="item.value">
                                            </el-option>
                                        </el-select>
                                        <!-- <input class="text fl" style="width:4.5rem;" placeholder="请输入..." v-model="warnconf.interval" type="number"> -->
                                    </div>
                                    <div class="three clearfix">
    ...
    export default {
        ...
        methods: {
            ...
            addWarn: function() {
                ...
                // newoption.notify.notify_group=_.cloneDeep(this.group_with_names) //告警推送配置
                // newoption.notify.notify_group.forEach(item => {
                //     delete(item.users)
                // })
                // console.info('提交的数据',newoption)
